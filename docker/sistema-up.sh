...
sudo docker run --name ngrok.local --ip=172.30.0.4 --net ebanx_net -it -e NGROK_AUTHTOKEN=2eYLFIbBBkjzkaKEPSe8mOArfvO_4pcffjNjPRXmibvttj5Kz ngrok/ngrok:latest http 172.30.0.2:80